...
__global__ void DenseBackwardPass(float * d_outputError, float * d_input, float * d_weights, float * d_bias, float * d_inputError, float * d_weightsError, int lr, int o_r, int o_c, int i_r, int i_c, int w_r, int w_c);
